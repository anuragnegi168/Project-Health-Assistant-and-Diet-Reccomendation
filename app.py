...
import os
from diet import bmi_calculator,bmr_calculator,tdee_calculator,calory_target
...
st.write("Personal Healh Assistant and Diet Recommendation Agent")
...
calorys = calory_target(tdee,aim)
...
col4.metric("Calorie Target",f"{calorys} Kcal")

tab1,tab2=st.tabs(['Diet Reccomendation','Health Assistance'])
if tab1:
